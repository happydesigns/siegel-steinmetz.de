  ...
  <div class="document page mb-4">
    ...
    <div class="content-wrapper">
      <TextImage class="mt-4" side="right">
        <TitledImage image="tombs_1.jpg" alt="Doppelstein Jura mit Bronze">
          Doppelstein Jura mit Bronze
        </TitledImage>
        <span class="text">
          <p>
    ...
    <div class="content-wrapper">
      <TextImage class="mt-6" side="left">
        <TitledImage image="tombs_2.jpg" alt="Doppelgrabmal Tarno Diorit">
          Doppelgrabmal Tarno Diorit
        </TitledImage>
        <span class="text">
          <p>
    ...
    <div class="content-wrapper">
      <TextImage class="mt-6" side="right">
        <TitledImage image="tombs_3.jpg" alt="Urnengrab Kalkstein">
          Urnengrab Kalkstein
        </TitledImage>
        <span class="text">
