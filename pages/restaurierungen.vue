    ...
    <section>
      <div class="content-wrapper">
        <TextImage class="mt-4" side="right">
          <TitledImage image="restorations_1.jpg" alt="Fensterumrahmung Solitudestr. Ludwigsburg">
            Restaurierung: Fensterumrahmung Solitudestr. Ludwigsburg
          </TitledImage>
          <span class="text">
      ...
      <div class="content-wrapper">
        <TextImage class="mt-6" side="left">
          <TitledImage image="restorations_2.jpg" alt="Austausch einer Säulenbasis">
            Austausch einer Säulenbasis aus dem Jahr 1890
          </TitledImage>
          <span class="text">
      ...
      <TextImage class="mt-6" side="right">
        <TitledImage image="restorations_3.jpg" alt="Uhu Statue" />
        <span class="text">
